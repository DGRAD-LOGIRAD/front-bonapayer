...
export default function AgentListModal({
  ...
  useEffect(() => {
    if (visible) {
      // Simule une API
      setAgents([
        { id: 1001, nom: "Kabila", prenom: "Jean", email: "jean.kabila@mail.com" },
        { id: 1002, nom: "Lumumba", prenom: "Patrice", email: "patrice.lumumba@mail.com" },
        { id: 1009, nom: "Mombaya", prenom: "Seth", email: "smombaya@gmail.com" },
      ]);
    }
  }, [visible]);
